      ...
      function(a, b, c) {
        ...
        !(function(a, c) {
          return 'undefined' != typeof b && null !== b
            ? (b.exports = c())
            : 'function' == typeof define && 'object' == typeof define.amd ? define(a, c) : (this[a] = c());
        })('payform', function() {
          ...
          return (
            ...
            (i = function(a) {
              ...
              return (
                (b = String.fromCharCode(a.which)),
                /^\d+$/.test(b)
                  ? ((c = a.target.value), /^\d\d$/.test(c) ? (a.target.value = c + ' / ') : void 0)
                  : void 0
              );
            }),
            (j = function(a) {
              ...
              return (
                ...
                '/' === c || ' ' === c
                  ? ((b = a.target.value), /^\d$/.test(b) && '0' !== b ? (a.target.value = '0' + b + ' / ') : void 0)
                  : void 0
              );
            }),
            (f = function(a) {
            ...
            (n = function(a) {
              ...
              return (
                (b = v(a.target)),
                (a.target.value = a.target.value.replace(/\D/g, '').slice(0, 4)),
                null != b && 'change' !== a.type ? a.target.setSelectionRange(b, b) : void 0
              );
            }),
            (t = function(a) {
                ...
                /^\d+$/.test(d) && !k(b.target)
                  ? ((e = (b.target.value + d).replace(/\D/g, '')),
                    ...
                    c && e.length > c.length[c.length.length - 1]
                      ? b.preventDefault()
                      : e.length > 16 ? b.preventDefault() : void 0)
                  : void 0
              );
            }),
            (s = function(a) {
              ...
              return (
                (b = String.fromCharCode(a.which)),
                /^\d+$/.test(b) && !k(a.target)
                  ? ((c = a.target.value + b), (c = c.replace(/\D/g, '')), c.length > 6 ? a.preventDefault() : void 0)
                  : void 0
              );
            }),
            (q = function(a) {
              ...
              return (
                (b = String.fromCharCode(a.which)),
                /^\d+$/.test(b) && !k(a.target)
                  ? ((c = a.target.value + b), c.length > 4 ? a.preventDefault() : void 0)
                  : void 0
              );
            }),
            ...
            (m.parseCardExpiry = function(a) {
              ...
              return (
                ...
                2 === (null != d ? d.length : void 0) &&
                  /^\d+$/.test(d) &&
                  ((c = new Date().getFullYear()), (c = c.toString().slice(0, 2)), (d = c + d)),
                (b = parseInt(b, 10)),
                (d = parseInt(d, 10)),
                { month: b, year: d }
              );
            ...
            (m.validateCardNumber = function(b) {
              ...
              return (
                (b = (b + '').replace(/\s+|-/g, '')),
                /^\d+$/.test(b)
                  ? ((c = a(b)), c ? ((e = b.length), d.call(c.length, e) >= 0 && (c.luhn === !1 || l(b))) : !1)
                  : !1
              );
            }),
            ...
            (m.validateCardCVC = function(a, c) {
              ...
              return (
                ...
                /^\d+$/.test(a)
                  ? ((e = b(c)),
                    null != e ? ((f = a.length), d.call(e.cvcLength, f) >= 0) : a.length >= 3 && a.length <= 4)
                  : !1
              );
            }),
              ...
              return (
                ...
                (c = a(b))
                  ? ((e = c.length[c.length.length - 1]),
                    (b = b.slice(0, e)),
                    c.format.global
                      ? null != (f = b.match(c.format)) ? f.join(' ') : void 0
                      : ((d = c.format.exec(b)),
                        null != d ? (d.shift(), (d = d.filter(Boolean)), d.join(' ')) : void 0))
                  : b
              );
            }),
